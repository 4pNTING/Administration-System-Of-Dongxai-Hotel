  ...
  const columns = useMemo<ColumnDef<CategoryWithActionsType, any>[]>(
    () => [
      ...
      columnHelper.accessor('categoryTitle', {
        ...
        cell: ({ row }) => (
          <div className='flex flex-row items-center'>
            <img src={row.original.image} width={28} height={38} className='rounded bg-actionHover' />
            <div>
      ...
      columnHelper.accessor('totalProduct', {
        header: 'ລະຫັດລາຍການ',
        cell: ({ row }) =>  <div className='flex flex-row items-center'>    <Typography variant='body2'>{row.original.description}</Typography></div>
      }),
